...
#get the past data of the last 4 hours

'''
assume the price data is stored at PRICE_DATA_PATH and the open interest data is stored at OPEN_INTEREST_PATH
'''

#transform the price data from 1m to 15m
for symbol in symbol_pool:
    print(f"Processing 15m{symbol}...")
...
for symbol in symbol_pool:
    ...
    file_path2 = os.path.join(PRICE_SAVE_PATH, f"{symbol}_UPERP_5m.csv")
